...
export const APP_SEARCH_CATALOG: AppSearchItem[] = [
  ...
  },
  {
    id: 'internet',
    title: 'Internet & data',
    subtitle: 'Mobile data and broadband',
    icon: 'wifi',
    keywords: 'internet data bundle spectranet starlink broadband wifi',
    action: { type: 'screen', screen: 'paybills' },
  },
  {
    id: 'bills',
    ...
    icon: 'receipt_long',
    keywords: 'bills electricity disco ikedc dstv gotv cable toll remita betting',
    action: { type: 'screen', screen: 'paybills' },
  },
  ...
  },
  {
    id: 'settlement',
    title: 'Settlement',
    subtitle: 'Bank payout cut-offs',
    icon: 'account_balance',
    keywords: 'settlement payout bank zenith providus cut-off',
    action: {
      type: 'toast',
      title: 'Settlement',
      message: 'Next settlement window posts at 6:00 PM WAT.',
    },
  },
  {
    id: 'utilities',
